...
import com.pdc.implementedPatterns.dependentClass.Espece;
import com.pdc.implementedPatterns.dependentClass.Exceptions.NonCompatible;
...
public abstract class Enclos implements Comparable {
    ...
    public Enclos(int id, double lng, double lrg) {
